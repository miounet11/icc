...
def test_goto_split_from_loaded_browser(client: icc) -> tuple[bool, str]:
    """
...
def test_goto_split_roundtrip_loaded_browser(client: icc) -> tuple[bool, str]:
    """
...
def run_tests() -> int:
    print("=" * 60)
    print("icc Browser goto_split Regression Test")
    print("=" * 60)
    print()
    ...
    try:
        with icc(socket_path=socket_path) as client:
