...
xcodebuild -project GhosttyTabs.xcodeproj -scheme icc -configuration Release -destination 'platform=macOS' build
pkill -x icc || true
sleep 0.2
APP_PATH="$(
...
APP_PROCESS_PATH="${APP_PATH}/Contents/MacOS/icc"
ATTEMPT=0
MAX_ATTEMPTS=20
