...
try writeImage(transparentMark, to: "AppIcon.icon/Assets/icc-icon-chevron 2.png")
try writeImage(transparentMark, to: "design/icc.icon/Assets/icc-icon-chevron 2.png")
