# Command Reference (icc Markdown)

## Opening a Markdown Panel

```bash
icc markdown open <path>
icc markdown <path>          # shorthand (implicit "open")
```
...
|------|-------------|---------|
| `--workspace <id\|ref\|index>` | Target workspace | `$ICC_WORKSPACE_ID` |
...
icc markdown open ./plan.md
icc markdown open /Users/me/project/plan.md
```
