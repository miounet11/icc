...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const t = await getTranslations({ locale, namespace: "blog.introducingIcc" });
  const url = locale === "en" ? "/blog/introducing-icc" : `/${locale}/blog/introducing-icc`;
  return {
    title: t("metaTitle"),
    description: t("metaDescription"),
    keywords: [
      "icc", "terminal", "macOS", "Ghostty", "libghostty",
...
export default function IntroducingIccPage() {
  const t = useTranslations("blog.posts.introducingIcc");
