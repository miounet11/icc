  ...
  "0.62.0": {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "Browser panels now support Cmd+F with inline find controls, so you can search long docs, dashboards, and issue threads without leaving icc.",
      },
      {
        title: "Vi Copy Mode",
        description:
      ...
      },
      {
        ...
        description:
          "icc now includes Japanese plus 16 additional languages, and a per-app language override lets you change the UI language without changing macOS system settings.",
      },
    ],
  },
  "0.61.0": {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "Hit Cmd+Shift+P to open a searchable command palette. Every action in icc is here: creating workspaces, toggling the sidebar, checking for updates, switching windows. Keyboard shortcuts are shown inline so you can learn them as you go.",
  ...
  "0.60.0": {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "The embedded browser now has full WebKit DevTools. Open them with the standard shortcut and they persist across tab switches. Inspect elements, debug JavaScript, and monitor network requests without leaving icc.",
