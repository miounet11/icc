#!/usr/bin/env python3
"""
Interactive test for Ctrl+C and Ctrl+D in icc terminal.

This script tests that control signals are properly handled.
Run this script inside the icc terminal.
...
def main():
    print("=" * 50)
    print("icc Control Signal Test")
    print("=" * 50)
    print("\nThis script tests if Ctrl+C and Ctrl+D work correctly.")
    print("Run this inside the icc terminal to verify the fix.\n")
