...
def wait_for_text(client: icc, surface_id: str, needle: str, timeout: float = 3.0) -> bool:
...
def main() -> int:
    ...
    p1 = (tmp / "icc drop [image] #1 (a).png").resolve()
    p2 = (tmp / "icc drop second & file!.jpg").resolve()
