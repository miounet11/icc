...
final class SidebarBranchOrderingTests: XCTestCase {
        ...
        let pullRequests = SidebarBranchOrdering.orderedUniquePullRequests(
            ...
            panelPullRequests: [
                first: pullRequestState(
                    number: 337,
                    label: "PR",
                    url: "https://github.com/manaflow-ai/icc/pull/337",
                    status: .open
                ),
                second: pullRequestState(
                    number: 18,
                    label: "MR",
                    url: "https://gitlab.com/manaflow/icc/-/merge_requests/18",
                    status: .open
                ),
                ...
                fourth: pullRequestState(
                    number: 92,
                    label: "PR",
                    url: "https://bitbucket.org/manaflow/icc/pull-requests/92",
                    status: .closed
                )
            ],
        ...
        let pullRequests = SidebarBranchOrdering.orderedUniquePullRequests(
            ...
            panelPullRequests: [
                first: pullRequestState(
                    number: 42,
                    label: "PR",
                    url: "https://github.com/manaflow-ai/icc/pull/42",
                    status: .open
                ),
                second: pullRequestState(
                    number: 42,
                    label: "MR",
                    url: "https://gitlab.com/manaflow/icc/-/merge_requests/42",
                    status: .open
                )
            ],
    ...
    func testOrderedUniquePullRequestsTreatsSameNumberAndLabelDifferentUrlsAsDistinct() {
        ...
        XCTAssertEqual(
            ...
            [
                "https://github.com/manaflow-ai/icc/pull/42",
    ...
    func testUpdatePanelPullRequestPreservesExistingChecksWhenUpdateOmitsThem() {
        ...
        workspace.updatePanelPullRequest(
            ...
            number: 42,
            label: "PR",
            url: URL(string: "https://github.com/manaflow-ai/icc/pull/42")!,
            status: .open,
            checks: .pass
        )
        workspace.updatePanelPullRequest(
    ...
    func testOrderedUniquePullRequestsUsesFallbackWhenNoPanelPullRequestsExist() {
        let fallback = pullRequestState(
            number: 11,
            label: "PR",
            url: "https://github.com/manaflow-ai/icc/pull/11",
            status: .open
        )
        let pullRequests = SidebarBranchOrdering.orderedUniquePullRequests(
            orderedPanelIds: [],
    ...
    func testUpdatePanelGitBranchClearsFocusedPullRequestWhenBranchChanges() {
        ...
        workspace.updatePanelPullRequest(
            ...
            number: 1629,
            label: "PR",
            url: URL(string: "https://github.com/manaflow-ai/icc/pull/1629")!,
            status: .open
        )
...
final class TerminalControllerSidebarDedupeTests: XCTestCase {
    ...
    func testNormalizeReportedDirectoryTrimsWhitespace() {
        XCTAssertEqual(
            TerminalController.normalizeReportedDirectory("   /Users/icc/project   "),
            "/Users/icc/project"
        )
    }
    ...
    func testNormalizeReportedDirectoryResolvesFileURL() {
        XCTAssertEqual(
            TerminalController.normalizeReportedDirectory("file:///Users/icc/project"),
            "/Users/icc/project"
        )
    }
