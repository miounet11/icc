...
final class UpdateLogStore {
    ...
    private let queue = DispatchQueue(label: "icc.update.log")
    ...
    private init() {
        ...
        logURL = logsDir.appendingPathComponent("Logs/icc-update.log")
        ensureLogFile()
    }
...
final class FocusLogStore {
    ...
    private let queue = DispatchQueue(label: "icc.focus.log")
    private var entries: [String] = []
    ...
    private init() {
        ...
        let logsDir = FileManager.default.urls(for: .libraryDirectory, in: .userDomainMask).first
            ?? FileManager.default.temporaryDirectory
        logURL = logsDir.appendingPathComponent("Logs/icc-focus.log")
        ensureLogFile()
    }
