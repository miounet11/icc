# icc terminfo overlay

icc ships Ghostty's `xterm-ghostty` terminfo entry, but the embedded
renderer in icc has differed from Ghostty's app renderer in how it treats
