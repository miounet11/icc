...
final class BrowserOmnibarSuggestionsUITests: XCTestCase {
    ...
    override func setUp() {
        ...
        dataPath = "/tmp/icc-ui-test-omnibar-suggestions-\(UUID().uuidString).json"
    ...
    func testOmnibarSuggestionsAlignToPillAndCmdNP() {
        ...
        app.launchEnvironment["ICC_UI_TEST_DISABLE_REMOTE_SUGGESTIONS"] = "1"
    ...
    func testOmnibarSuggestionsCmdNPWhenAddressBarFocused() {
        ...
        app.launchEnvironment["ICC_UI_TEST_GOTO_SPLIT_PATH"] = dataPath
        app.launchEnvironment["ICC_UI_TEST_DISABLE_REMOTE_SUGGESTIONS"] = "1"
        app.launchEnvironment["ICC_UI_TEST_REMOTE_SUGGESTIONS_JSON"] = #"["go tutorial","go json","go fmt"]"#
        launchAndEnsureForeground(app)
    ...
    private func seedBrowserHistoryForTest(entries: [(String, String)]? = nil, seedEntries: [SeedEntry]? = nil) {
        ...
        let bundleId = "com.icc.app.debug"
