...
final class SidebarHelpMenuUITests: XCTestCase {
    ...
    func testHelpMenuOpensKeyboardShortcutsSection() {
        ...
        app.launchEnvironment["ICC_UI_TEST_MODE"] = "1"
    ...
    func testHelpMenuCheckForUpdatesShowsSparkleDialogOnFirstAttempt() {
        ...
        app.launchEnvironment["ICC_UI_TEST_MODE"] = "1"
        app.launchEnvironment["ICC_UI_TEST_FEED_URL"] = "https://icc.test/appcast.xml"
        app.launchEnvironment["ICC_UI_TEST_FEED_MODE"] = "available"
        app.launchEnvironment["ICC_UI_TEST_UPDATE_VERSION"] = "99.0.0"
        app.launchEnvironment["ICC_UI_TEST_AUTO_ALLOW_PERMISSION"] = "1"
        launchAndActivate(app)
    ...
    func testHelpMenuCheckForUpdatesShowsLatestVersionWhenDeferredUpdateIsStale() {
        ...
        app.launchEnvironment["ICC_UI_TEST_FEED_MODE"] = "available"
        app.launchEnvironment["ICC_UI_TEST_UPDATE_VERSION"] = "99.0.0"
        app.launchEnvironment["ICC_UI_TEST_DEFERRED_UPDATE_VERSION"] = "98.0.0"
        app.launchEnvironment["ICC_UI_TEST_AUTO_ALLOW_PERMISSION"] = "1"
        launchAndActivate(app)
...
final class FeedbackComposerShortcutUITests: XCTestCase {
    ...
    func testCmdOptionFWorksFromSettingsWindow() {
        let app = XCUIApplication()
        app.launchEnvironment["ICC_UI_TEST_MODE"] = "1"
        app.launchEnvironment["ICC_UI_TEST_SHOW_SETTINGS"] = "1"
        app.launch()
        app.activate()
...
final class CommandPaletteAllSurfacesUITests: XCTestCase {
    ...
    private let hiddenSurfaceToken = "icc-command-palette-hidden-surface"
    private let visibleSurfaceToken = "icc-command-palette-visible-surface"
    private let noMatchWorkspaceQuery = "icc-command-palette-no-match"

    override func setUp() {
        super.setUp()
        continueAfterFailure = false
        socketPath = "/tmp/icc-ui-test-command-palette-\(UUID().uuidString).sock"
    ...
    func testMinimalModeToggleKeepsSettingsWindowFocused() throws {
        let app = XCUIApplication()
        let diagnosticsPath = "/tmp/icc-ui-test-settings-focus-\(UUID().uuidString).json"
        ...
        let diagnostics = waitForDiagnostics(
            ...
            data["keyWindowIdentifier"] == "icc.settings" && data["settingsWindowIsKey"] == "1"
        }
