...
final class MenuKeyEquivalentRoutingUITests: XCTestCase {
    ...
    override func setUp() {
        ...
        gotoSplitPath = "/tmp/icc-ui-test-goto-split-\(UUID().uuidString).json"
        keyequivPath = "/tmp/icc-ui-test-keyequiv-\(UUID().uuidString).json"
    ...
    private func launchWithBrowserSetup() -> XCUIApplication {
        ...
        app.launchEnvironment["ICC_UI_TEST_GOTO_SPLIT_SETUP"] = "1"
        app.launchEnvironment["ICC_UI_TEST_GOTO_SPLIT_PATH"] = gotoSplitPath
        app.launchEnvironment["ICC_UI_TEST_KEYEQUIV_PATH"] = keyequivPath
        app.launch()
        app.activate()
...
final class SplitCloseRightBlankRegressionUITests: XCTestCase {
    ...
    override func setUp() {
        ...
        dataPath = "/tmp/icc-ui-test-split-close-right-\(UUID().uuidString).json"
        socketPath = "/tmp/icc-ui-test-socket-\(UUID().uuidString).sock"
        diagnosticsPath = "/tmp/icc-ui-test-diagnostics-\(UUID().uuidString).json"
        ...
        let leaf = "icc-ui-test-split-close-right-shots-\(UUID().uuidString)"
    ...
    func testClosingBothRightSplitsDoesNotLeaveBlankPane() {
        let app = XCUIApplication()
        app.launchEnvironment["ICC_UI_TEST_SPLIT_CLOSE_RIGHT_SETUP"] = "1"
        app.launchEnvironment["ICC_UI_TEST_SPLIT_CLOSE_RIGHT_PATH"] = dataPath
        app.launchEnvironment["ICC_SOCKET_PATH"] = socketPath
        app.launchEnvironment["ICC_UI_TEST_DIAGNOSTICS_PATH"] = diagnosticsPath
        app.launch()
        app.activate()
    ...
    func testReproBlankAfterClosingRightSplitsViaShortcuts() {
        ...
        app.launchEnvironment["ICC_UI_TEST_SPLIT_CLOSE_RIGHT_SETUP"] = "1"
        app.launchEnvironment["ICC_UI_TEST_SPLIT_CLOSE_RIGHT_PATH"] = dataPath
        app.launchEnvironment["ICC_UI_TEST_SPLIT_CLOSE_RIGHT_VISUAL"] = "1"
        // The regression can be a single compositor frame; capture enough post-close frames to
        // deterministically catch it.
        app.launchEnvironment["ICC_UI_TEST_SPLIT_CLOSE_RIGHT_ITERATIONS"] = "12"
        // Close quickly (closer to how a user can click two close buttons back-to-back).
        app.launchEnvironment["ICC_UI_TEST_SPLIT_CLOSE_RIGHT_CLOSE_DELAY_MS"] = "0"
        app.launchEnvironment["ICC_UI_TEST_SPLIT_CLOSE_RIGHT_BURST_FRAMES"] = "32"
        // Repro order that still flashes for users: split left/right first, then split top/down.
        app.launchEnvironment["ICC_UI_TEST_SPLIT_CLOSE_RIGHT_PATTERN"] = "close_right_lrtd"
        app.launch()
        app.activate()
    ...
    func testReproStretchAfterClosingSingleRightSplit() {
        ...
        app.launchEnvironment["ICC_UI_TEST_SPLIT_CLOSE_RIGHT_PATH"] = dataPath
        app.launchEnvironment["ICC_UI_TEST_SPLIT_CLOSE_RIGHT_VISUAL"] = "1"
        app.launchEnvironment["ICC_UI_TEST_SPLIT_CLOSE_RIGHT_ITERATIONS"] = "16"
        app.launchEnvironment["ICC_UI_TEST_SPLIT_CLOSE_RIGHT_CLOSE_DELAY_MS"] = "0"
        app.launchEnvironment["ICC_UI_TEST_SPLIT_CLOSE_RIGHT_BURST_FRAMES"] = "36"
        app.launchEnvironment["ICC_UI_TEST_SPLIT_CLOSE_RIGHT_PATTERN"] = "close_right_single"
        app.launch()
        app.activate()
    ...
    func testReproBlankAfterClosingBottomSplitsViaShortcuts() {
        ...
        app.launchEnvironment["ICC_UI_TEST_SPLIT_CLOSE_RIGHT_CLOSE_DELAY_MS"] = "0"
        app.launchEnvironment["ICC_UI_TEST_SPLIT_CLOSE_RIGHT_BURST_FRAMES"] = "32"
        app.launchEnvironment["ICC_UI_TEST_SPLIT_CLOSE_RIGHT_PATTERN"] = "close_bottom"
        app.launch()
        app.activate()
    ...
    func testReproBlankAfterClosingRightSplitsTopFirstWithGap() {
        ...
        app.launchEnvironment["ICC_UI_TEST_SPLIT_CLOSE_RIGHT_PATH"] = dataPath
        app.launchEnvironment["ICC_UI_TEST_SPLIT_CLOSE_RIGHT_VISUAL"] = "1"
        app.launchEnvironment["ICC_UI_TEST_SPLIT_CLOSE_RIGHT_ITERATIONS"] = "14"
        // Reproduce manual close cadence: close top-right, observe one frame, then close bottom-right.
        app.launchEnvironment["ICC_UI_TEST_SPLIT_CLOSE_RIGHT_CLOSE_DELAY_MS"] = "120"
        app.launchEnvironment["ICC_UI_TEST_SPLIT_CLOSE_RIGHT_BURST_FRAMES"] = "40"
        app.launchEnvironment["ICC_UI_TEST_SPLIT_CLOSE_RIGHT_PATTERN"] = "close_right_lrtd"
        app.launch()
        app.activate()
    ...
    func testReproBlankAfterClosingRightSplitsBottomFirstViaShortcuts() {
        ...
        app.launchEnvironment["ICC_UI_TEST_SPLIT_CLOSE_RIGHT_CLOSE_DELAY_MS"] = "120"
        app.launchEnvironment["ICC_UI_TEST_SPLIT_CLOSE_RIGHT_BURST_FRAMES"] = "40"
        app.launchEnvironment["ICC_UI_TEST_SPLIT_CLOSE_RIGHT_PATTERN"] = "close_right_lrtd_bottom_first"
        app.launch()
        app.activate()
    ...
    func testReproBlankAfterClosingRightSplitsWithoutFocusingRightPanes() {
        ...
        app.launchEnvironment["ICC_UI_TEST_SPLIT_CLOSE_RIGHT_CLOSE_DELAY_MS"] = "0"
        app.launchEnvironment["ICC_UI_TEST_SPLIT_CLOSE_RIGHT_BURST_FRAMES"] = "36"
        app.launchEnvironment["ICC_UI_TEST_SPLIT_CLOSE_RIGHT_PATTERN"] = "close_right_lrtd_unfocused"
        app.launch()
        app.activate()
    ...
    private func assertPaneRendersAndUpdates(
        ...
        app.typeText("yes ICC_AFTER_CLOSE_\(label)_\(token) | head -n 30\n")
